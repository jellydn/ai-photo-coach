/**
 * Scoring algorithms - Pure functions for shot-readiness score calculation
 */
...
import { getSubscoreLabel } from "./labels";
import {
...
export function computeScore(
	...
	return {
		...
		subScores,
		weakestSubscore,
		weakestSubscoreLabel: getSubscoreLabel(weakestSubscore),
		meetsThreshold,
		method,
	};
}
